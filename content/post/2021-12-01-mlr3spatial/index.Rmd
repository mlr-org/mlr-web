...
We support spatial raster objects created by the [terra](https://CRAN.R-project.org/package=terra), [raster](https://CRAN.R-project.org/package=raster) and [stars](https://CRAN.R-project.org/package=stars) packages with the [`DataBackendRaster`](https://mlr3spatial.mlr-org.com/reference/DataBackendRaster.html).
Additionally, vector data created with the package [sf](https://CRAN.R-project.org/package=sf) is handled with the [`DataBackendVector`](https://mlr3spatial.mlr-org.com/reference/DataBackendVector.html).
