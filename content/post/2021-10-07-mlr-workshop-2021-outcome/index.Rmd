...
FIXME: @be-marc - need a link/reference here :)

Another improvement for {mlr3hyperband} was the support for asynchronous evaluations of hyperparameter configurations.
...
FIXME: @be-marc: can we link the paper you showed me for this?

### [mlr3mbo](https://github.com/mlr-org/mlr3mbo)

We finally found the time to port {mlrMBO} from the old {mlr} over to {mlr3} - welcome {mlr3MBO}!
It is not yet on CRAN as we still need to apply some final touches - but you are welcome to try it by installing the package from GitHub.
...
We've done substantial work on {mlr3fairness} and plan to release it within the workshop or soon after.
The package will include bias-auditing metrics, visualizations and debiasing techniques for arbitrary learners.
