...
How these methods are defined, can be read in the [mlr tutorial](https://mlr-org.github.io/mlr/articles/tutorial/devel/multilabel.html) or in more detail in our [paper](https://arxiv.org/pdf/1703.08991.pdf). Enough theory now, let's apply these methods on our dataset.
...
We also implemented common multilabel performance measures. Here is a list with [available multilabel performance measures](https://mlr-org.github.io/mlr/articles/tutorial/devel/measures.html#multilabel-classification):
```{r}
...
Here I'll show you how to use resampling methods in the multilabel setting. Resampling methods are key for assessing the performance of a learning algorithm. To read more about resampling, see the page on our [tutorial](https://mlr-org.github.io/mlr/articles/tutorial/devel/resample.html).
...
Many methods, which are available in mlr, like [preprocessing](https://mlr-org.github.io/mlr/articles/tutorial/devel/preproc.html), [tuning](https://mlr-org.github.io/mlr/articles/tutorial/devel/tune.html) or [benchmark experiments](https://mlr-org.github.io/mlr/articles/tutorial/devel/benchmark_experiments.html) can also be used for multilabel datasets and the good thing here is: the syntax stays the same!
