...
blogdown::html_page:
  toc: true
---
We are happy to announce that a new extension package has joined the CRAN family of mlr3 packages.
...
So far, applying such methods in both R and the mlr ecosystem was not particular easy since they were spread across various R packages.
...
For a quick and rather technial introduction please see the ["Get Started"](https://mlr3spatiotempcv.mlr-org.com/articles/mlr3spatiotempcv.html) vignette.
