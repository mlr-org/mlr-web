...
*mlr* developers are currently working on [*mlr*3](https://github.com/*mlr*-org/*mlr*3) which aims at being even more extensible and using R6, data.table and other useful packages that were not used by *mlr*.
