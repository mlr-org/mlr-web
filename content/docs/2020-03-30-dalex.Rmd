---
title: Understand your models: Explainable machine learning with mlr3 and DALEX
authors: ["michel-lang"]
date: '2020-03-30'
...
[Przemysław Biecek](https://github.com/pbiecek) and [Szymon Maksymiuk](https://github.com/maksymiuks) added a [new chapter](https://mlr3book.mlr-org.com/interpretability-dalex.html) to the [mlr3 book](https://mlr3book.mlr-org.com/) on how to analyze models fitted with [mlr3](https://cran.r-project.org/package=mlr3) with the excellent [DALEX package](https://cran.r-project.org/package=DALEX).
