...
While [_mlr_](https://github.com/mlr-org/mlr) was one big package that included everything starting from preprocessing, tuning, feature-selection to visualization, [mlr3](https://github.com/mlr-org/mlr3) is a **package framework** consisting of multiple packages containing specific parts of the functionality required for a complete machine-learning workflow.
